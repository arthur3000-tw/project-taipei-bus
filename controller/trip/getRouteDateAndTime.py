...
@router.get("/Route/TripDateAndTime/")
async def get_route_date_and_time(request:Request,route_name:str,start_date:date,end_date:date,start_time:time,end_time:time):
